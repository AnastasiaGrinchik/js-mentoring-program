...
function getShortest(wordArray) {
    ...
    let minNumber = Math.min.apply(null, newArr);
    let indexMinNumber = newArr.indexOf(minNumber);
    return wordArray[indexMinNumber];
}
...
function getGoogle(n) {
    let letterO = 'o';
    letterO = letterO.repeat(n);
    return 'g' + letterO + 'gle';
}
...
function getTotalPath(path) {
    let newArr = path.reduce(function (acc, current) {
